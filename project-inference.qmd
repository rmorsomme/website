...
The data set that you analyze in this project needs to have at least 100 observations and 5 meaningful variables (identifier variables such as "name", "social security number" or "id" do not count), including at least one categorical and one numerical variable.
...
|                                                                                                   |            |
| -   The main body is at most 7 pages long and does not contain any `R` code, warning nor message. | 1          |
|                                                                                                   |            |
