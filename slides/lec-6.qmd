...
Exercise [25.9](https://openintro-ims.netlify.app/inf-model-mlr.html#chp25-exercises) (the book uses SSE for rSSR)
...
Exercise [8.11](https://openintro-ims.netlify.app/model-mlr.html#chp8-exercises). In addition, fit the candidate models in `R` with the command `lm`.
...
-   Model selection through
    ...
    -   predictive performance
    -   stepwise procedure
-   You are ready for the prediction project!
