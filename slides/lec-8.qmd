...
**Statistic**: any function of some data; e.g., average, median, iqr, maximum, variance, etc.
...
-   use the corresponding sample statistic as an estimate
    ...
    -   to estimate the median age of Duke students, simply compute the median in the sample.
...
Suppose the sample consists in **55 heads** of 100 flips
...
-   The coin might be fair, but it is implausible for a fair coin to give $65$ heads out of $100$ flips.
